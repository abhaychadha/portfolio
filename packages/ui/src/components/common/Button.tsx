...
const baseClass =
  "bg-primary flex items-center justify-center rounded-[100px] transition-transform hover:scale-105 no-underline border-0 cursor-pointer";
...
const labelClass = "font-manrope font-bold leading-none text-neutral-black text-sm sm:text-[16px] uppercase";
